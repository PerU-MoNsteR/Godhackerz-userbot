...
from userbot.exclusive import ANIMATED_STICKER_PNAME, STICKER_PACK_NAME
from userbot.utils import admin_cmd

DEFAULTUSER = (
    str(ALIVE_NAME) if ALIVE_NAME else "No Name Set Yet, Check @Godhackerzuserbot"
)
...
async def _(event):
    ...
    if is_a_s:
        ...
        if userid == 1111847352:
            ...
            packshortname = (
                f"PremiumStickers_Animated_{userid}"  # format: Uni_Borg_userid
            )
